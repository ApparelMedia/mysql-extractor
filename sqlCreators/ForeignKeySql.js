...
function ForeignKeySql (tableName, dbName) {
    return 'select distinct FRGN.COLUMN_NAME, FRGN.CONSTRAINT_NAME,FRGN.REFERENCED_TABLE_NAME, FRGN.REFERENCED_COLUMN_NAME, COL.COLUMN_TYPE, COL.EXTRA, COL.COLUMN_KEY, COL.IS_NULLABLE, FRGN.UPDATE_RULE, FRGN.DELETE_RULE ' +
        'from (select A.CONSTRAINT_NAME, A.COLUMN_NAME, A.REFERENCED_TABLE_NAME, A.REFERENCED_COLUMN_NAME, B.UPDATE_RULE, B.DELETE_RULE ' +
