...
function ForeignKeySql (tableName, dbName) {
    return 'select distinct FRGN.COLUMN_NAME, FRGN.REFERENCED_TABLE_NAME, FRGN.REFERENCED_COLUMN_NAME, COL.COLUMN_TYPE, COL.EXTRA, COL.COLUMN_KEY, COL.IS_NULLABLE, FRGN.UPDATE_RULE, FRGN.DELETE_RULE ' +
